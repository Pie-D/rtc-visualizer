...
const locales = {
  en: {
    ...
    logsTab: 'Logs',
    aiTab: 'AI Analysis',
    aiAnalyzeBtn: 'Analyze with Gemma AI',
    aiAnalyzing: 'Gemma 4 is analyzing logs...',
    aiEmptyLogs: 'No logs found to analyze.',
    aiError: 'Error analyzing logs:',
    aiResultTitle: 'Gemma AI Diagnostic Report',
  ...
  vi: {
    ...
    logsTab: 'Nhật ký',
    aiTab: 'Phân tích AI',
    aiAnalyzeBtn: 'Phân tích bằng Gemma AI',
    aiAnalyzing: 'Gemma 4 đang phân tích logs...',
    aiEmptyLogs: 'Không tìm thấy logs nào để phân tích.',
    aiError: 'Lỗi khi phân tích logs:',
    aiResultTitle: 'Báo cáo chẩn đoán của Gemma AI',
